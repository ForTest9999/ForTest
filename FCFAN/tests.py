...
def LandmarkError(imageServer, faceAlignment, extraLandmarks, OrgsInd, normalization='centers', showResults=False, verbose=False):
    errors = []
    ...
    for i in range(nImgs):
        ...
        if showResults:
            ...
            # plt.show()
            # plt.clf()
            fig1.savefig('Img' + str(i) + '_deformed.png')
