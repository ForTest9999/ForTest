...
class LandmarkDeformLayer2_Org6(MergeLayer):
    def __init__(self, moms, init_landmarks, n_T, sigmaV=6.5614, **kwargs):
        super(LandmarkDeformLayer2_Org6, self).__init__([moms, init_landmarks], **kwargs)
    ...
    def compute_landmarks_helper(self, moms, init_landmarks):
        ...
        mask = T.zeros((68, 2))
        mask = T.set_subtensor(mask[31:36, :], np.ones((5, 2)))
        ...
        initLandmarks_loca1 = T.alloc(initLandmarks_aftmas[31, :], 68, 2)
        initLandmarks_loca1_aftmas = initLandmarks_loca1 * mask
        initLandmarks_loca2 = T.alloc(initLandmarks_aftmas[32, :], 68, 2)
        initLandmarks_loca2_aftmas = initLandmarks_loca2 * mask
        initLandmarks_loca3 = T.alloc(initLandmarks_aftmas[33, :], 68, 2)
        initLandmarks_loca3_aftmas = initLandmarks_loca3 * mask
        initLandmarks_loca4 = T.alloc(initLandmarks_aftmas[34, :], 68, 2)
        initLandmarks_loca4_aftmas = initLandmarks_loca4 * mask
        initLandmarks_loca5 = T.alloc(initLandmarks_aftmas[35, :], 68, 2)
        ...
        dp = T.set_subtensor(dp[35, :], val5)

        deformedShape = initLandmarks_aftmas + (dp * self.tau)

        deformedShape_loca1 = T.alloc(deformedShape[31, :], 68, 2)
        deformedShape_loca2 = T.alloc(deformedShape[32, :], 68, 2)
        deformedShape_loca3 = T.alloc(deformedShape[33, :], 68, 2)
        deformedShape_loca4 = T.alloc(deformedShape[34, :], 68, 2)
        deformedShape_loca5 = T.alloc(deformedShape[35, :], 68, 2)
        ...
        dp1 = T.set_subtensor(dp1[31, :], val11)
        ...
        dp1 = T.set_subtensor(dp1[32, :], val22)
        ...
        dp1 = T.set_subtensor(dp1[33, :], val33)
        ...
        dp1 = T.set_subtensor(dp1[34, :], val44)
        ...
        dp1 = T.set_subtensor(dp1[35, :], val55)
