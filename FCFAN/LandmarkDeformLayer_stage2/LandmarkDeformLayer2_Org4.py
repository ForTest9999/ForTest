...
class LandmarkDeformLayer2_Org4(MergeLayer):
    def __init__(self, moms, init_landmarks, n_T, sigmaV=11.2157, **kwargs):
        super(LandmarkDeformLayer2_Org4, self).__init__([moms, init_landmarks], **kwargs)
    ...
    def compute_landmarks_helper(self, moms, init_landmarks):
        ...
        mask = T.zeros((68, 2))
        mask = T.set_subtensor(mask[22:27, :], np.ones((5, 2)))
        ...
        initLandmarks_loca1 = T.alloc(initLandmarks_aftmas[22, :], 68, 2)
        initLandmarks_loca1_aftmas = initLandmarks_loca1 * mask
        initLandmarks_loca2 = T.alloc(initLandmarks_aftmas[23, :], 68, 2)
        initLandmarks_loca2_aftmas = initLandmarks_loca2 * mask
        initLandmarks_loca3 = T.alloc(initLandmarks_aftmas[24, :], 68, 2)
        initLandmarks_loca3_aftmas = initLandmarks_loca3 * mask
        initLandmarks_loca4 = T.alloc(initLandmarks_aftmas[25, :], 68, 2)
        initLandmarks_loca4_aftmas = initLandmarks_loca4 * mask
        initLandmarks_loca5 = T.alloc(initLandmarks_aftmas[26, :], 68, 2)
        ...
        dp = T.set_subtensor(dp[26, :], val5)

        deformedShape = initLandmarks_aftmas + (dp * self.tau)

        deformedShape_loca1 = T.alloc(deformedShape[22, :], 68, 2)
        deformedShape_loca2 = T.alloc(deformedShape[23, :], 68, 2)
        deformedShape_loca3 = T.alloc(deformedShape[24, :], 68, 2)
        deformedShape_loca4 = T.alloc(deformedShape[25, :], 68, 2)
        deformedShape_loca5 = T.alloc(deformedShape[26, :], 68, 2)
        ...
        dp1 = T.set_subtensor(dp1[22, :], val11)
        ...
        dp1 = T.set_subtensor(dp1[23, :], val22)
        ...
        dp1 = T.set_subtensor(dp1[24, :], val33)
        ...
        dp1 = T.set_subtensor(dp1[25, :], val44)
        ...
        dp1 = T.set_subtensor(dp1[26, :], val55)
