...
class LandmarkDeformLayer2_Org8(MergeLayer):
    def __init__(self, moms, init_landmarks, n_T, sigmaV=6.4939, **kwargs):
        super(LandmarkDeformLayer2_Org8, self).__init__([moms, init_landmarks], **kwargs)
    ...
    def compute_landmarks_helper(self, moms, init_landmarks):
        ...
        mask = T.zeros((68, 2))
        mask = T.set_subtensor(mask[42:48, :], np.ones((6, 2)))
        ...
        initLandmarks_loca1 = T.alloc(initLandmarks_aftmas[42, :], 68, 2)
        initLandmarks_loca1_aftmas = initLandmarks_loca1 * mask
        initLandmarks_loca2 = T.alloc(initLandmarks_aftmas[43, :], 68, 2)
        initLandmarks_loca2_aftmas = initLandmarks_loca2 * mask
        initLandmarks_loca3 = T.alloc(initLandmarks_aftmas[44, :], 68, 2)
        initLandmarks_loca3_aftmas = initLandmarks_loca3 * mask
        initLandmarks_loca4 = T.alloc(initLandmarks_aftmas[45, :], 68, 2)
        initLandmarks_loca4_aftmas = initLandmarks_loca4 * mask
        initLandmarks_loca5 = T.alloc(initLandmarks_aftmas[46, :], 68, 2)
        initLandmarks_loca5_aftmas = initLandmarks_loca5 * mask
        initLandmarks_loca6 = T.alloc(initLandmarks_aftmas[47, :], 68, 2)
        ...
        dp = T.set_subtensor(dp[47, :], val6)

        deformedShape = initLandmarks_aftmas + (dp * self.tau)

        deformedShape_loca1 = T.alloc(deformedShape[42, :], 68, 2)
        deformedShape_loca2 = T.alloc(deformedShape[43, :], 68, 2)
        deformedShape_loca3 = T.alloc(deformedShape[44, :], 68, 2)
        deformedShape_loca4 = T.alloc(deformedShape[45, :], 68, 2)
        deformedShape_loca5 = T.alloc(deformedShape[46, :], 68, 2)
        deformedShape_loca6 = T.alloc(deformedShape[47, :], 68, 2)
        ...
        dp1 = T.set_subtensor(dp1[42, :], val11)
        ...
        dp1 = T.set_subtensor(dp1[43, :], val22)
        ...
        dp1 = T.set_subtensor(dp1[44, :], val33)
        ...
        dp1 = T.set_subtensor(dp1[45, :], val44)
        ...
        dp1 = T.set_subtensor(dp1[46, :], val55)
        ...
        dp1 = T.set_subtensor(dp1[47, :], val66)
