...
class LandmarkDeformLayer2_Org10(MergeLayer):
    def __init__(self, moms, init_landmarks, n_T, sigmaV=7.9841, **kwargs):
        super(LandmarkDeformLayer2_Org10, self).__init__([moms, init_landmarks], **kwargs)
    ...
    def compute_landmarks_helper(self, moms, init_landmarks):
        ...
        mask = T.zeros((68, 2))
        mask = T.set_subtensor(mask[55:60, :], np.ones((5, 2)))
        ...
        initLandmarks_loca1 = T.alloc(initLandmarks_aftmas[55, :], 68, 2)
        initLandmarks_loca1_aftmas = initLandmarks_loca1 * mask
        initLandmarks_loca2 = T.alloc(initLandmarks_aftmas[56, :], 68, 2)
        initLandmarks_loca2_aftmas = initLandmarks_loca2 * mask
        initLandmarks_loca3 = T.alloc(initLandmarks_aftmas[57, :], 68, 2)
        initLandmarks_loca3_aftmas = initLandmarks_loca3 * mask
        initLandmarks_loca4 = T.alloc(initLandmarks_aftmas[58, :], 68, 2)
        initLandmarks_loca4_aftmas = initLandmarks_loca4 * mask
        initLandmarks_loca5 = T.alloc(initLandmarks_aftmas[59, :], 68, 2)
        ...
        dp = T.set_subtensor(dp[59, :], val5)

        deformedShape = initLandmarks_aftmas + (dp * self.tau)

        deformedShape_loca1 = T.alloc(deformedShape[55, :], 68, 2)
        deformedShape_loca2 = T.alloc(deformedShape[56, :], 68, 2)
        deformedShape_loca3 = T.alloc(deformedShape[57, :], 68, 2)
        deformedShape_loca4 = T.alloc(deformedShape[58, :], 68, 2)
        deformedShape_loca5 = T.alloc(deformedShape[59, :], 68, 2)
        ...
        dp1 = T.set_subtensor(dp1[55, :], val11)
        ...
        dp1 = T.set_subtensor(dp1[56, :], val22)
        ...
        dp1 = T.set_subtensor(dp1[57, :], val33)
        ...
        dp1 = T.set_subtensor(dp1[58, :], val44)
        ...
        dp1 = T.set_subtensor(dp1[59, :], val55)
