...
class LandmarkDeformLayer2_Org9(MergeLayer):
    def __init__(self, moms, init_landmarks, n_T, sigmaV=12.0824, **kwargs):
        super(LandmarkDeformLayer2_Org9, self).__init__([moms, init_landmarks], **kwargs)
    ...
    def compute_landmarks_helper(self, moms, init_landmarks):
        ...
        mask = T.zeros((68, 2))
        mask = T.set_subtensor(mask[48:55, :], np.ones((7, 2)))
        ...
        initLandmarks_loca1 = T.alloc(initLandmarks_aftmas[48, :], 68, 2)
        initLandmarks_loca1_aftmas = initLandmarks_loca1 * mask
        initLandmarks_loca2 = T.alloc(initLandmarks_aftmas[49, :], 68, 2)
        initLandmarks_loca2_aftmas = initLandmarks_loca2 * mask
        initLandmarks_loca3 = T.alloc(initLandmarks_aftmas[50, :], 68, 2)
        initLandmarks_loca3_aftmas = initLandmarks_loca3 * mask
        initLandmarks_loca4 = T.alloc(initLandmarks_aftmas[51, :], 68, 2)
        initLandmarks_loca4_aftmas = initLandmarks_loca4 * mask
        initLandmarks_loca5 = T.alloc(initLandmarks_aftmas[52, :], 68, 2)
        initLandmarks_loca5_aftmas = initLandmarks_loca5 * mask
        initLandmarks_loca6 = T.alloc(initLandmarks_aftmas[53, :], 68, 2)
        initLandmarks_loca6_aftmas = initLandmarks_loca6 * mask
        initLandmarks_loca7 = T.alloc(initLandmarks_aftmas[54, :], 68, 2)
        ...
        dp = T.set_subtensor(dp[54, :], val7)

        deformedShape = initLandmarks_aftmas + (dp * self.tau)

        deformedShape_loca1 = T.alloc(deformedShape[48, :], 68, 2)
        deformedShape_loca2 = T.alloc(deformedShape[49, :], 68, 2)
        deformedShape_loca3 = T.alloc(deformedShape[50, :], 68, 2)
        deformedShape_loca4 = T.alloc(deformedShape[51, :], 68, 2)
        deformedShape_loca5 = T.alloc(deformedShape[52, :], 68, 2)
        deformedShape_loca6 = T.alloc(deformedShape[53, :], 68, 2)
        deformedShape_loca7 = T.alloc(deformedShape[54, :], 68, 2)
        ...
        dp1 = T.set_subtensor(dp1[48, :], val11)
        ...
        dp1 = T.set_subtensor(dp1[49, :], val22)
        ...
        dp1 = T.set_subtensor(dp1[50, :], val33)
        ...
        dp1 = T.set_subtensor(dp1[51, :], val44)
        ...
        dp1 = T.set_subtensor(dp1[52, :], val55)
        ...
        dp1 = T.set_subtensor(dp1[53, :], val66)
        ...
        dp1 = T.set_subtensor(dp1[54, :], val77)
