...
import theano
class LandmarkConvergeLayer2(MergeLayer):
    def __init__(self, landmarks_Org1, landmarks_Org2, landmarks_Org3, landmarks_Org4, landmarks_Org5, landmarks_Org6,
        ...
        super(LandmarkConvergeLayer2, self).__init__([landmarks_Org1, landmarks_Org2, landmarks_Org3, landmarks_Org4,
                                                     landmarks_Org5, landmarks_Org6, landmarks_Org7, landmarks_Org8,
                                                     landmarks_Org11, landmarks_Org12, landmarks_Org13, landmarks_Org14], **kwargs)
    ...
    def converge_helper(self, landmarksOrg1, landmarksOrg2, landmarksOrg3, landmarksOrg4,
                                                     ...
                                                     landmarksOrg11, landmarksOrg12, landmarksOrg13, landmarksOrg14):
