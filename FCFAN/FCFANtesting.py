...
# commonErrs = tests.LandmarkError(commonSet, network, extraLandmarks, extraOrgsInd, normalization, showResults, verbose)
print ("Processing challenging subset of the 300W public test set (IBUG dataset)")
challengingErrs = tests.LandmarkError(challengingSet, network, extraLandmarks, extraOrgsInd, normalization, showResults, verbose)
#
...
# w300Errs = tests.LandmarkError(w300, network, extraLandmarks, extraOrgsInd, normalization, showResults, verbose)
